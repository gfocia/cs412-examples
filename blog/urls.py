...
from django.contrib.auth import views as auth_views ## NEW on 10/29 
from . import views
...
urlpatterns = [
    ...
    path(r'create_article', views.CreateArticleView.as_view(), name="create_article"), ## NEW on 10/17 

    # authentication urls 
    path('login/', auth_views.LoginView.as_view(template_name="blog/login.html"), name='login'), ## NEW on 10/29 
    path('login/', auth_views.LogoutView.as_view(next_page="show_all"), name="logout"), ## NEW on 10/29 
]